<template>
	<svg viewBox="0 0 850.39 850.39" xmlns="http://www.w3.org/2000/svg" :width="width" :height="height">
		<g fill="currentColor">
			...
			<path
				d="M445.71,222.35c-0.1,59.62-0.2,119.25-0.3,178.87c0.07,2.57,0.66,14.6,10.45,24.31c2.12,2.1,10.82,10.2,24.23,10.22
		...
		c-10.95-0.06-18.36,6.34-20.75,8.63C446.36,209.11,445.78,220.03,445.71,222.35z"
			/>
			<path
				d="M429.69,222.35c0.1,59.62,0.2,119.25,0.3,178.87c-0.07,2.57-0.66,14.6-10.45,24.31c-2.12,2.1-10.82,10.2-24.23,10.22
